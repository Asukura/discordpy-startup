...
async def on_message(message):
    if "大好きだよ" in message.content:
        ...
        await message.channel.send("よいしょ！",file = discord.File("image/81712332_p0_master1200.jpg"))

    elif message.content.startswith("アリサの水浴び盗撮"):
        await message.channel.send("任せてください！でもご褒美のおちんちんはくださいよ？",file = discord.File("image/82404243_p0_master1200.jpg"))

    elif message.content.startswith("アリサ　乗って"):
        await message.channel.send("こわれちゃうぅ...//",file = discord.File("image/59549145_p3_master1200.jpg")) 
        ...
        await message.channel.send("君に触ってもらえるのが一番の幸せだよ...//",file = discord.File("image/63612392_p0_master1200.jpg")) 
        
    elif message.content.startswith("お姉ちゃん"):
        await message.channel.send("はぁ..はぁ..♡",file = discord.File("image/81348479_p0_master1200.jpg"))
